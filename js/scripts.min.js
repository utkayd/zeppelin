(function(a) {
    a(document).ready(function() {
        ...
        (a("#top-header").addClass("after-scroll"), a("#logo-header .logo").removeClass("logo-light").addClass("logo-dark"));
        ...
        google.maps.event.addDomListener(window, "load", function() {
            ...
            function e(b) {
                r.geocode({
                    ...
                    c == google.maps.GeocoderStatus.OK && b[1] && a.each(b[1].address_components, function(b, c) {
